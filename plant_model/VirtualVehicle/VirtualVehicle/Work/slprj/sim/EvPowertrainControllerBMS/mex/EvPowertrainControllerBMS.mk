...
MAKECMD         = /mnt/data/Data/software/matlab/2023a-linux/bin/glnxa64/gmake
HOST            = UNIX
BUILD           = yes
SYS_TARGET_FILE = any
...
PRODUCT                 = $(RELATIVE_PATH_TO_ANCHOR)/EvPowertrainControllerBMS_msf.mexa64
MAKEFILE                = EvPowertrainControllerBMS.mk
MATLAB_ROOT             = /mnt/data/Data/software/matlab/2023a-linux
ALT_MATLAB_ROOT         = /mnt/data/Data/software/matlab/2023a-linux
...
SYSTEM_LIBS             = -L"/mnt/data/Data/software/matlab/2023a-linux/bin/glnxa64" -lmwipp -lfixedpoint -lmwmathutil -lmwsl_AsyncioQueue -lmwsf_runtime -lmwslexec_simlog -lmwcoder_ToAsyncQueueTgtAppSvc -lmwsl_simtarget_instrumentation -lmwsl_simtarget_core -lmwstringutil -lmx -lmex
...
MODELLIB                  = EvPowertrainControllerBMS_msf.mexa64
