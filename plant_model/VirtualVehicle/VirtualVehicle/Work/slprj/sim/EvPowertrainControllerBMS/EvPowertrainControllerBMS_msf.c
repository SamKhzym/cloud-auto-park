...
real_T rtP__CtrlBcuTrlrBrkGain2f2VirtualVehicleTemplate_sldd_ ; real_T
...
memcpy ( & ( rtP__CtrlBcuTrlrBrkGain2f2VirtualVehicleTemplate_sldd_ ) ,
...
GlobalPrm_1 , sizeof ( real_T ) * 11 ) ; } if ( !
ssGetModelRefGlobalParamData ( S , 2 , ( void * * ) ( & GlobalPrm_2 ) ) )
return ; if ( GlobalPrm_2 != NULL ) { ( void ) memcpy ( & (
rtP__CtrlVcuEvRegenBrkCutOff2f2EvVCU_sldd_ [ 0 ] ) , GlobalPrm_2 , sizeof (
real_T ) * 2 ) ; } if ( ! ssGetModelRefGlobalParamData ( S , 3 , ( void * * )
( & GlobalPrm_3 ) ) ) return ; if ( GlobalPrm_3 != NULL ) { ( void ) memcpy (
& ( rtP__CtrlVcuEvRegenBrkSpdBpt2f2EvVCU_sldd_ [ 0 ] ) , GlobalPrm_3 , sizeof
( real_T ) * 2 ) ; } if ( ! ssGetModelRefGlobalParamData ( S , 4 , ( void * *
) ( & GlobalPrm_4 ) ) ) return ; if ( GlobalPrm_4 != NULL ) { ( void ) memcpy
( & ( rtP__CtrlVcuEvSocBpt2f2EvVCU_sldd_ [ 0 ] ) , GlobalPrm_4 , sizeof (
real_T ) * 11 ) ; } if ( ! ssGetModelRefGlobalParamData ( S , 5 , ( void * *
...
( rtP__PlntDiffrntlRatio2f2Drivetrain_sldd_ ) , GlobalPrm_11 , sizeof (
real_T ) ) ; } if ( ! ssGetModelRefGlobalParamData ( S , 12 , ( void * * ) (
& GlobalPrm_12 ) ) ) return ; if ( GlobalPrm_12 != NULL ) { ( void ) memcpy (
& ( rtP__PlntEM1EffTbl2f2ElectricMachine1_sldd_ [ 0 ] ) , GlobalPrm_12 ,
sizeof ( real_T ) * 154 ) ; } if ( ! ssGetModelRefGlobalParamData ( S , 13 ,
( void * * ) ( & GlobalPrm_13 ) ) ) return ; if ( GlobalPrm_13 != NULL ) { (
void ) memcpy ( & ( rtP__PlntEM1Trq2f2ElectricMachine1_sldd_ [ 0 ] ) ,
GlobalPrm_13 , sizeof ( real_T ) * 14 ) ; } if ( !
ssGetModelRefGlobalParamData ( S , 14 , ( void * * ) ( & GlobalPrm_14 ) ) )
return ; if ( GlobalPrm_14 != NULL ) { ( void ) memcpy ( & (
rtP__PlntEM1TrqEff2f2ElectricMachine1_sldd_ [ 0 ] ) , GlobalPrm_14 , sizeof (
real_T ) * 11 ) ; } }
#endif
static void mdlInitializeConditions ( SimStruct * S ) { ngz2pfeakpt * dw = (
ngz2pfeakpt * ) ssGetDWork ( S , 0 ) ; real_T * o_o_o_B_1_1 = ( real_T * )
ssGetOutputPortSignal ( S , 0 ) ; real_T * o_o_o_B_1_5 = ( real_T * )
...
ssGetOutputPortSignal ( S , 7 ) ; cdlti3213i ( o_o_o_B_1_1 , o_o_o_B_1_5 ,
o_o_o_B_1_6 , o_o_o_B_1_7 , o_o_o_B_1_8 ) ; } static void
mdlPeriodicOutputUpdate ( SimStruct * S , int_T tid ) { ngz2pfeakpt * dw = (
ngz2pfeakpt * ) ssGetDWork ( S , 0 ) ; real_T const * i_k0qkz30lvp = ( real_T
* ) ssGetInputPortSignal ( S , 0 ) ; real_T const * i_jtifdqkawf = ( real_T *
) ssGetInputPortSignal ( S , 1 ) ; real_T const * i_d1n3ldkpku = ( real_T * )
ssGetInputPortSignal ( S , 2 ) ; real_T const * i_cgphvvw5p5 = ( real_T * )
ssGetInputPortSignal ( S , 3 ) ; real_T const * i_ixdt5lrz0n = ( real_T * )
ssGetInputPortSignal ( S , 4 ) ; real_T const * i_k2gzv0qee1 = ( real_T * )
ssGetInputPortSignal ( S , 5 ) ; real_T const * i_kzx0saseph = ( real_T * )
ssGetInputPortSignal ( S , 6 ) ; real_T const * i_oexkfnmire = ( real_T * )
ssGetInputPortSignal ( S , 7 ) ; real_T const * i_eamd20nyvw = ( real_T * )
ssGetInputPortSignal ( S , 8 ) ; real_T const * i_dglz1u0ikr = ( real_T * )
ssGetInputPortSignal ( S , 9 ) ; real_T const * i_f1si5n25dt = ( real_T * )
ssGetInputPortSignal ( S , 10 ) ; real_T * o_o_o_B_1_1 = ( real_T * )
...
ssGetOutputPortSignal ( S , 8 ) ; if ( tid == 0 ) { EvPowertrainControllerBMS
( i_k0qkz30lvp , i_jtifdqkawf , i_d1n3ldkpku , i_cgphvvw5p5 , i_ixdt5lrz0n ,
i_k2gzv0qee1 , i_kzx0saseph , i_oexkfnmire , i_eamd20nyvw , i_dglz1u0ikr ,
i_f1si5n25dt , o_o_o_B_1_1 , o_B_1_2 , o_B_1_3 , o_B_1_4 , o_o_o_B_1_5 ,
o_o_o_B_1_6 , o_o_o_B_1_7 , o_o_o_B_1_8 , o_B_1_9 , & ( dw -> rtb ) ) ; } }
...
slmrInitializeIOPortDataVectors ( S , 11 , 9 ) ; if ( ! ssSetNumInputPorts (
S , 11 ) ) return ; if ( ! ssSetInputPortVectorDimension ( S , 0 , 1 ) )
...
if ( ! ssSetDataTypeSize ( S , mdlrefDWTypeId , sizeof ( ngz2pfeakpt ) ) )
...
static void mdlSetupRuntimeResources ( SimStruct * S ) { ngz2pfeakpt * dw = (
ngz2pfeakpt * ) ssGetDWork ( S , 0 ) ; real_T * o_o_o_B_1_1 = ( real_T * )
ssGetOutputPortSignal ( S , 0 ) ; real_T * o_o_o_B_1_5 = ( real_T * )
ssGetOutputPortSignal ( S , 4 ) ; real_T * o_o_o_B_1_6 = ( real_T * )
ssGetOutputPortSignal ( S , 5 ) ; real_T * o_o_o_B_1_7 = ( real_T * )
ssGetOutputPortSignal ( S , 6 ) ; real_T * o_o_o_B_1_8 = ( real_T * )
ssGetOutputPortSignal ( S , 7 ) ; void * sysRanPtr = ( NULL ) ; int sysTid =
0 ; ssGetContextSysRanBCPtr ( S , & sysRanPtr ) ; ssGetContextSysTid ( S , &
sysTid ) ; if ( sysTid == CONSTANT_TID ) { sysTid = 0 ; } aqzgcfjqsf ( S ,
...
ssGetOutputPortSignal ( S , 5 ) ; real_T * o_o_o_B_1_7 = ( real_T * )
ssGetOutputPortSignal ( S , 6 ) ; real_T * o_o_o_B_1_8 = ( real_T * )
ssGetOutputPortSignal ( S , 7 ) ; mdlProcessParameters ( S ) ; f5tbg1pt2m (
o_o_o_B_1_1 , o_o_o_B_1_5 , o_o_o_B_1_6 , o_o_o_B_1_7 , o_o_o_B_1_8 , & ( dw
-> rtb ) ) ; } static void mdlOutputs ( SimStruct * S , int_T tid ) {
ngz2pfeakpt * dw = ( ngz2pfeakpt * ) ssGetDWork ( S , 0 ) ; real_T const *
i_k0qkz30lvp = ( real_T * ) ssGetInputPortSignal ( S , 0 ) ; real_T const *
i_jtifdqkawf = ( real_T * ) ssGetInputPortSignal ( S , 1 ) ; real_T const *
i_d1n3ldkpku = ( real_T * ) ssGetInputPortSignal ( S , 2 ) ; real_T const *
i_cgphvvw5p5 = ( real_T * ) ssGetInputPortSignal ( S , 3 ) ; real_T const *
i_ixdt5lrz0n = ( real_T * ) ssGetInputPortSignal ( S , 4 ) ; real_T const *
i_k2gzv0qee1 = ( real_T * ) ssGetInputPortSignal ( S , 5 ) ; real_T const *
i_kzx0saseph = ( real_T * ) ssGetInputPortSignal ( S , 6 ) ; real_T const *
i_oexkfnmire = ( real_T * ) ssGetInputPortSignal ( S , 7 ) ; real_T const *
i_eamd20nyvw = ( real_T * ) ssGetInputPortSignal ( S , 8 ) ; real_T const *
i_dglz1u0ikr = ( real_T * ) ssGetInputPortSignal ( S , 9 ) ; real_T const *
i_f1si5n25dt = ( real_T * ) ssGetInputPortSignal ( S , 10 ) ; real_T *
o_o_o_B_1_1 = ( real_T * ) ssGetOutputPortSignal ( S , 0 ) ; real_T * o_B_1_2
...
EvPowertrainControllerBMSTID1 ( & ( dw -> rtb ) ) ; } if ( tid !=
CONSTANT_TID && tid != PARAMETER_TUNING_TID ) { EvPowertrainControllerBMS (
i_k0qkz30lvp , i_jtifdqkawf , i_d1n3ldkpku , i_cgphvvw5p5 , i_ixdt5lrz0n ,
i_k2gzv0qee1 , i_kzx0saseph , i_oexkfnmire , i_eamd20nyvw , i_dglz1u0ikr ,
i_f1si5n25dt , o_o_o_B_1_1 , o_B_1_2 , o_B_1_3 , o_B_1_4 , o_o_o_B_1_5 ,
o_o_o_B_1_6 , o_o_o_B_1_7 , o_o_o_B_1_8 , o_B_1_9 , & ( dw -> rtb ) ) ; } }
static void mdlTerminate ( SimStruct * S ) { ngz2pfeakpt * dw = ( ngz2pfeakpt
* ) ssGetDWork ( S , 0 ) ; b3eofzzeql ( & ( dw -> rtm ) ) ; return ; }
