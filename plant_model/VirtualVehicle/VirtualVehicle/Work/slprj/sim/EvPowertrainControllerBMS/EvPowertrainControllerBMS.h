#ifndef RTW_HEADER_EvPowertrainControllerBMS_h_
#define RTW_HEADER_EvPowertrainControllerBMS_h_
...
#include <stddef.h>
typedef struct { real_T ibqm4fsfc5 ; real_T e5d3ouqstz ; } lsoeg0nito ;
struct c5hhynsofi4_ { real_T P_15 ; real_T P_16 ; real_T P_17 ; real_T P_18 ;
...
real_T P_30 [ 14 ] ; real_T P_31 ; real_T P_32 ; real_T P_33 ; real_T P_34 [
14 ] ; real_T P_35 ; real_T P_36 ; real_T P_37 ; real_T P_38 ; real_T P_39 [
14 ] ; real_T P_40 ; real_T P_41 ; real_T P_42 ; real_T P_43 ; real_T P_44 ;
real_T P_45 ; real_T P_46 ; real_T P_47 [ 14 ] ; real_T P_48 ; real_T P_49 ;
real_T P_50 ; real_T P_51 ; real_T P_52 ; real_T P_53 ; real_T P_54 ; real_T
P_55 ; real_T P_56 ; real_T P_57 ; real_T P_58 ; uint32_T P_59 [ 2 ] ; } ;
struct nfq1kx1roz { struct SimStruct_tag * _mdlRefSfcnS ; struct {
...
typedef struct { lsoeg0nito rtb ; obv4iumo0b rtm ; } ngz2pfeakpt ; extern
real_T rtP__CtrlBcuTrlrBrkGain2f2VirtualVehicleTemplate_sldd_ ; extern real_T
...
rtP__PlntEM1TrqEff2f2ElectricMachine1_sldd_ [ 11 ] ; extern void aqzgcfjqsf (
SimStruct * _mdlRefSfcnS , int_T mdlref_TID0 , int_T mdlref_TID1 , obv4iumo0b
* const ftj5mqhdtx , lsoeg0nito * localB , void * sysRanPtr , int contextTid
...
extern void mr_EvPowertrainControllerBMS_SetDWork ( ngz2pfeakpt * mdlrefDW ,
const mxArray * ssDW ) ; extern void
mr_EvPowertrainControllerBMS_RegisterSimStateChecksum ( SimStruct * S ) ;
extern mxArray * mr_EvPowertrainControllerBMS_GetSimStateDisallowedBlocks ( )
; extern const rtwCAPI_ModelMappingStaticInfo *
EvPowertrainControllerBMS_GetCAPIStaticMap ( void ) ; extern void cdlti3213i
( real_T * i2aqjuli5s , real_T * f5q1lumvzg , real_T * j2naykddwm , real_T *
ea4r4f3bwk , real_T * cewk4ryfod ) ; extern void f5tbg1pt2m ( real_T *
i2aqjuli5s , real_T * f5q1lumvzg , real_T * j2naykddwm , real_T * ea4r4f3bwk
, real_T * cewk4ryfod , lsoeg0nito * localB ) ; extern void
...
k0pcor1dt1 , const real_T * nirwbhd0cx , const real_T * fk0g32hxsg , const
real_T * iatkkfawdg , const real_T * dyj0glinq3 , real_T * i2aqjuli5s ,
real_T * ou3e1khm3v , real_T gpmtm1hqzh [ 4 ] , real_T maa0jy4xlg [ 6 ] ,
real_T * f5q1lumvzg , real_T * j2naykddwm , real_T * ea4r4f3bwk , real_T *
cewk4ryfod , real_T * fzi32imnif , lsoeg0nito * localB ) ; extern void
EvPowertrainControllerBMSTID1 ( lsoeg0nito * localB ) ; extern void
b3eofzzeql ( obv4iumo0b * const ftj5mqhdtx ) ;
#endif
